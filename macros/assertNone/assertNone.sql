{% macro assertNone(test_number, macro_to_test_with_args, expected, is_query=False) %}
...
{% macro assertNotNone(test_number, macro_to_test_with_args, expected, is_query=False) %}
